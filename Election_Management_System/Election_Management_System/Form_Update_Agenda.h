...
namespace Election_Management_System {
	...
	/// <summary>
	/// Summary for Form_Update_Agenda
	/// </summary>
	public ref class Form_Update_Agenda : public System::Windows::Forms::Form
	{
	public:
		Form_Update_Agenda(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btn_Update->Click += gcnew System::EventHandler(this, &Form_Update_Agenda::btn_Update_Click);
			// 
			// txt_Election_ID
			// 
			...
			this->Name = L"Form_Update_Agenda";
			this->Text = L"Form_Update_Agenda";
			this->Load += gcnew System::EventHandler(this, &Form_Update_Agenda::Form_Update_Agenda_Load);
...
#pragma endregion
	private: System::Void Form_Update_Agenda_Load(System::Object^  sender, System::EventArgs^  e) {
