...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lbl_username->Location = System::Drawing::Point(380, 14);
			...
			// btn_submit
			// 
			this->btn_submit->Location = System::Drawing::Point(292, 415);
			...
			// txt_search
			// 
			this->txt_search->Location = System::Drawing::Point(255, 89);
			this->txt_search->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->txt_search->Name = L"txt_search";
			this->txt_search->Size = System::Drawing::Size(170, 26);
			this->txt_search->TabIndex = 45;
			// 
			// btn_club_add
			// 
			this->btn_club_add->Location = System::Drawing::Point(531, 249);
			this->btn_club_add->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->btn_club_add->Name = L"btn_club_add";
			this->btn_club_add->Size = System::Drawing::Size(112, 35);
			...
			// txt_full_name
			// 
			this->txt_full_name->Location = System::Drawing::Point(223, 366);
			...
			// btn_club_delete
			// 
			this->btn_club_delete->Location = System::Drawing::Point(223, 249);
			this->btn_club_delete->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->btn_club_delete->Name = L"btn_club_delete";
			this->btn_club_delete->Size = System::Drawing::Size(120, 35);
			...
			this->label2->Location = System::Drawing::Point(45, 366);
			...
			// txt_year_of_join
			// 
			this->txt_year_of_join->Location = System::Drawing::Point(223, 306);
			...
			this->btn_search->Font = (gcnew System::Drawing::Font(L"Century Gothic", 7.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->btn_search->Location = System::Drawing::Point(513, 80);
			this->btn_search->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btn_search->Name = L"btn_search";
			this->btn_search->Size = System::Drawing::Size(119, 45);
			...
			this->combo_department->Location = System::Drawing::Point(134, 48);
			this->combo_department->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->combo_department->Name = L"combo_department";
			this->combo_department->Size = System::Drawing::Size(180, 28);
			...
			this->label7->Location = System::Drawing::Point(29, 306);
			...
			this->combo_add_club->Location = System::Drawing::Point(531, 202);
			this->combo_add_club->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->combo_add_club->Name = L"combo_add_club";
			this->combo_add_club->Size = System::Drawing::Size(180, 28);
			this->combo_add_club->TabIndex = 41;
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(27, 102);
			...
			this->panel_Update->Location = System::Drawing::Point(13, 172);
			this->panel_Update->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->panel_Update->Name = L"panel_Update";
			this->panel_Update->Size = System::Drawing::Size(836, 502);
			...
			this->combo_club->Location = System::Drawing::Point(198, 202);
			this->combo_club->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->combo_club->Name = L"combo_club";
			this->combo_club->Size = System::Drawing::Size(180, 28);
			this->combo_club->TabIndex = 39;
			// 
			// combo_hostel
			// 
			this->combo_hostel->FormattingEnabled = true;
			this->combo_hostel->Location = System::Drawing::Point(172, 102);
			this->combo_hostel->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->combo_hostel->Name = L"combo_hostel";
			this->combo_hostel->Size = System::Drawing::Size(180, 28);
			this->combo_hostel->TabIndex = 37;
			// 
			// combo_program
			// 
			this->combo_program->FormattingEnabled = true;
			this->combo_program->Location = System::Drawing::Point(162, 150);
			this->combo_program->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->combo_program->Name = L"combo_program";
			this->combo_program->Size = System::Drawing::Size(180, 28);
			this->combo_program->TabIndex = 38;
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(44, 154);
